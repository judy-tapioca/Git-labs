...
│   ├── my_string.cpp/hpp
│   ├── rect.cpp/hpp
│   └── text_wrapper.cpp/hpp
└── tests/
    ├── CMakeLists.txt
    ├── test_bounding_rect.cpp
    ├── test_rect_basic_properties.cpp
    └── test_rect_operations.cpp
```

### 3.4 Основной CMakeLists.txt
