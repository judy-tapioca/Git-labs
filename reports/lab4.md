...
Официальный сайт Kubuntu: https://kubuntu.org
Официальный сайт Ubuntu: https://ubuntu.com

### Организация-разработчик
Kubuntu разрабатывается командой Kubuntu Council при поддержке Canonical Ltd. Это community-driven проект.

### Базовый дистрибутив
Kubuntu основан на Ubuntu, который в свою очередь основан на Debian.
