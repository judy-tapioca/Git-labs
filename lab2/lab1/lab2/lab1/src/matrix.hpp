...
public:
  ...
  // (done) TODO: what is the difference between this operator and copy c-tor?
  Matrix &operator=(const Matrix &other);
// Copy constructor — builds a brand new object from another
//Assignment operator — overwrites an already existing  object
  ~Matrix();
